  ...
  <table class="grid">
    ...
    <tr>
      ...
      <td class="actions">
        ...
        {{if $.CanShares}}
        <a class="btn btn-quiet btn-sm btn-icon" href="/archives/{{.ID}}/shares" title="Share" aria-label="Share {{.Key}}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M18 8a3 3 0 10-2.83-4"/><path d="M6 12a3 3 0 102.83 4"/><path d="M18 16a3 3 0 11-2.83-4"/><path d="M8.22 13.34l8.58 4.64"/><path d="M15.17 6.02L8.22 10.66"/></svg></a>
        {{end}}
        {{if $.CanDelete}}
